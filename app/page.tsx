...
/**
 * Mapeamento das abas -> componente renderizado
 * Ajuste a ordem aqui para mudar a sequência visual.
 */
const TABS = [
...
export default function Page() {
  // tela inicial (ajuste se quiser começar em outra aba)
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-slate-900 dark:bg-[#0b0d12] dark:text-slate-100">
      <div className="mx-auto max-w-6xl px-4 py-6">
        ...
        {/* Conteúdo da aba ativa (somente UM visível) */}
